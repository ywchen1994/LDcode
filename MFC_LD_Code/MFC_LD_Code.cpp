...
BEGIN_MESSAGE_MAP(CMFC_LD_CodeApp, CWinApp)
...
CMFC_LD_CodeApp::CMFC_LD_CodeApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_LD_CodeApp 物件

CMFC_LD_CodeApp theApp;


// CMFC_LD_CodeApp 初始設定

BOOL CMFC_LD_CodeApp::InitInstance()
{
